...
def printGameOver():
    ...
    if Score == "D+" or Score == "C-" or Score == "C0" or Score == "C+":
        label3 = myfont.render("press r to jesugang", 1, (255, 255, 255))
    else:
        label3 = myfont.render("You can't jesugang", 1, (255, 255, 255))
